...
const en: Messages = {
  ...
  auth: {
    ...
    installApp: {
      linkLabel: 'Add to home screen',
      title: 'Add repfuel to your home screen',
      intro: 'Installed as an app, repfuel opens full-screen, without an address bar, right from your home screen.',
      iosTitle: 'iPhone/iPad (Safari)',
      iosStep1: '1. Open repfuel in Safari.',
      iosStep2: '2. Tap the Share icon in the toolbar.',
      iosStep3: '3. Scroll down in the menu and tap "Add to Home Screen".',
      iosStep4: '4. Tap "Add" in the top right corner.',
      androidTitle: 'Android (Chrome)',
      androidStep1: '1. Open repfuel in Chrome.',
      androidStep2: '2. Tap the three-dot menu in the top right corner.',
      androidStep3: '3. Tap "Install app" and confirm with "Install".',
    },
  },
  errors: {
  ...
  activities: {
    ...
    kcalLabel: 'Calories (kcal, optional)',
    saveButton: 'Log',
    deleteConfirm: 'Really delete this activity?',
    types: {
      walk: 'Walking',
      run: 'Running',
      bike: 'Cycling',
  ...
  chat: {
    ...
    memory: {
      ...
      clearAllConfirm: 'Really delete the entire coach memory? The coach forgets all remembered goals, preferences and constraints.',
    ...
    proposals: {
      ...
      retry: 'Reload',
      barOne: 'Pending proposal',
      barOther: 'Pending proposals',
      barReview: 'Review',
      ...
      similarHint: 'Tap an exercise to replace it in the proposal.',
      similarEmpty: 'No similar exercises found.',
      swapAction: 'Swap',
      swapError: 'The exercise could not be swapped.',
