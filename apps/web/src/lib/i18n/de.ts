...
const de = {
  ...
  activities: {
    title: 'Aktivitäten',
    logButton: 'Aktivität eintragen',
    typeLabel: 'Aktivität',
    durationLabel: 'Dauer (Min)',
    kcalLabel: 'Kalorien (kcal, optional)',
    saveButton: 'Eintragen',
    deleteConfirm: 'Diese Aktivität wirklich löschen?',
    types: {
      walk: 'Gehen',
      run: 'Laufen',
      bike: 'Radfahren',
  ...
  chat: {
    ...
    proposals: {
      ...
      retry: 'Erneut laden',
      barOne: 'Offener Vorschlag',
      barOther: 'Offene Vorschläge',
      barReview: 'Ansehen',
      ...
      targetLabel: 'Vorgabe',
      similarTitle: 'Ähnliche Übungen',
      similarHint: 'Antippen ersetzt die Übung im Vorschlag.',
      similarEmpty: 'Keine ähnlichen Übungen gefunden.',
      swapAction: 'Tauschen',
      swapError: 'Die Übung konnte nicht getauscht werden.',
